...
sudo pacman -S --needed fastfetch inkscape archlinux-wallpaper unrar arch-audit --noconfirm
...
sudo pacman -S --needed ttf-liberation-mono-nerd ttf-ubuntu-font-family inter-font ttf-ms-win11-auto --noconfirm
...
cp -rT $RDIR/images/icons/. ~/.repo-resources/icons/
